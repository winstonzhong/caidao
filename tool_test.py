...
demo = {
    "类型" : "血压记录",
    "图片" : "https://file.j1.sale/api/file/test/blood_pressure_1.png",
    "数据" : {"高压": 135, "低压": 94},
    "图片识别内容" : "图中展示的是一个电子血压计。它的屏幕上清晰地显示着血压值，高压为135，低压为94。此外，它还有脉搏/分钟、用户切换、记忆、开始/停止等按钮。整个电子血压计外观简洁，便于操作。",
}


demo2 = {
    "类型" : "热量记录",
    "图片" : "https://file.j1.sale/api/file/test/lunch_1.jpg",
    "数据" : {"总热量(千卡)": 3400, "蛋白质(克)": 100, "脂肪(克)": 200, "碳水化合物(克)": 200, "膳食纤维(克)": 10},
    "图片识别内容" : "这是一张摆放在木质桌面上的美食图片。图片中心是一条蒸熟的鱼，鱼身上淋有汤汁，鱼身上还撒有葱花、香菜和花生米。鱼的周围摆放着四个菜和一碗汤。\n\n从左上角顺时针看，第一个是一盘炒豆角，豆角翠绿，上面还点缀着一些肉片；第二个是一盘炒白菜，白菜片洁白；第三个是一盘汤，里面有玉米、胡萝卜、肉丸和一些绿色的香菜；第四个是一盘炒四季豆，四季豆油亮，上面也撒有肉片。\n\n整体来看，这是一顿丰盛的家常便饭，色彩搭配鲜明，让人食欲大开。",
}

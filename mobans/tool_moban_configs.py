...
import tool_static
from tool_resource import get_resource_dir

# BASE_DIR = pathlib.Path(__file__).parent
BASE_DIR = get_resource_dir('mobans')
...
CFG = {
    ...
    "提取图片信息_直接_详细": {
        "提示词": """详细提取以下图片链接中的内容, 如果是餐食拍摄, 在详细列出图片内容详情后， 请分别评估各菜品、主食、水（汤，饮料）的克数(g); 如果是体重计, 请详细识别体重的读数和单位;如果是血糖,血压,尿酸等,同样详细识别其读数,单位和细节; 如果是身体或者病患处的拍摄,请详细描述图中的病症问题:\n{url}""",
    },
    "提取图片信息_模版": {
        "模版文件": "提取图片信息.html",
    },
